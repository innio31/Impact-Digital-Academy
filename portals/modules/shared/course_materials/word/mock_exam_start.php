<?php
// modules/shared/course_materials/MSWord/mock_exam_start.php
...
/**
 * MO-100 Mock Exam Simulation Class
 */
class MO100MockExam
{
    private $conn;
    ...
    private $user_role;
    private $class_id;
    private $exam_duration = 2700; // 45 minutes in seconds (MO-100 duration)
    private $max_score = 1000;
    private $passing_score = 700;
    private $questions = [];
    private $selected_questions = [];
    private $total_exam_questions = 35; // MO-100 typically has 35-45 questions
    ...
    private function loadQuestionsFromDatabase(): void
    {
        ...
        $sql = "SELECT * FROM mock_exam_questions 
                WHERE exam_type = 'MO-100' AND is_active = 1";
        ...
        if ($result && $result->num_rows > 0) {
            ...
            // Always select performance questions (approximately 40% of exam)
            $performance_count = count($performance_questions);
            $selected_performance_count = min(14, $performance_count); // 40% of 35 = 14
    ...
    private function getStaticQuestions(): array
    {
        return [
            1 => [
                ...
                'text' => 'You need to save a document as a template that can be reused. Which file format should you choose?',
                'options' => [
                    'A' => '.docx',
                    'B' => '.pdf',
                    'C' => '.dotx',
            ...
            2 => [
                ...
                'question_number' => 2,
                'domain' => 'Manage Documents',
                'text' => 'Which view displays the document without margins, headers, footers, or page breaks?',
                'options' => [
                    'A' => 'Print Layout',
                    'B' => 'Web Layout',
                    'C' => 'Read Mode',
            ...
            3 => [
                'id' => 3,
                'question_number' => 3,
                'domain' => 'Insert and Format Text, Paragraphs, and Sections',
                'text' => 'What is the keyboard shortcut to copy text formatting to another selection?',
                'options' => [
                    'A' => 'Ctrl+Shift+C',
            ...
            4 => [
                ...
                'question_number' => 4,
                'domain' => 'Insert and Format Text, Paragraphs, and Sections',
                'text' => 'You want to create a section where the text flows in two columns. Which option should you use?',
                'options' => [
                    'A' => 'Page Layout > Breaks > Column',
                    'B' => 'Layout > Columns > Two',
                    'C' => 'Insert > Text Box',
                    'D' => 'Design > Page Color'
                ],
                'correct_answer' => 'B',
            ...
            5 => [
                'id' => 5,
                'question_number' => 5,
                'domain' => 'Manage Tables and Lists',
                'text' => 'How do you sort a table alphabetically by the values in the first column?',
                'options' => [
                    'A' => 'Table Tools > Sort > Ascending',
                    'B' => 'Select the column > Home > Sort',
                    'C' => 'Right-click > Sort A to Z',
                    'D' => 'Layout tab > Sort'
                ],
                'correct_answer' => 'D',
                'points' => 10,
            ...
            6 => [
                ...
                'question_number' => 6,
                'domain' => 'Manage Tables and Lists',
                'text' => 'Which option allows you to continue numbering from a previous list?',
                'options' => [
                    'A' => 'Restart at 1',
                    'B' => 'Continue Numbering',
                    'C' => 'Set Numbering Value',
                    'D' => 'Reset List'
                ],
                'correct_answer' => 'C',
                'points' => 10,
            ...
            7 => [
                'id' => 7,
                'question_number' => 7,
                'domain' => 'Create and Manage References',
                'text' => 'Where do you find the option to insert a table of contents that updates automatically?',
                'options' => [
                    'A' => 'Insert tab > Table of Contents',
                    'B' => 'References tab > Table of Contents',
                    'C' => 'Layout tab > Table',
                    'D' => 'Design tab > Table Styles'
                ],
                'correct_answer' => 'B',
                'points' => 15,
                'type' => 'multiple_choice',
            ...
            8 => [
                ...
                'question_number' => 8,
                'domain' => 'Create and Manage References',
                'text' => 'What type of citation is placed at the end of a document?',
                'options' => [
                    'A' => 'Footnote',
                    'B' => 'Endnote',
                    'C' => 'Bibliography',
            ...
            9 => [
                'id' => 9,
                'question_number' => 9,
                'domain' => 'Insert and Format Graphic Elements',
                'text' => 'Which wrapping style allows text to flow around all sides of an image?',
                'options' => [
                    'A' => 'In Line with Text',
                    'B' => 'Square',
                    'C' => 'Tight',
            ...
            10 => [
                ...
                'question_number' => 10,
                'domain' => 'Insert and Format Graphic Elements',
                'text' => 'Where can you add alternative text to an image for accessibility?',
                'options' => [
                    'A' => 'Format tab > Alt Text',
                    'B' => 'Home tab > Font group',
                    'C' => 'Insert tab > Pictures',
            ...
            11 => [
                'id' => 11,
                'question_number' => 11,
                'domain' => 'PERFORMANCE: Manage Documents',
                'text' => 'PERFORMANCE TASK: Save the current document as a PDF with the following settings: Optimize for Standard quality, include document properties.',
                'options' => [
                    'A' => 'Completed',
                    'B' => 'Not Completed',
                ...
                'points' => 25,
                'type' => 'performance',
                'instructions' => 'Go to File > Save As. Choose PDF as file type. Click Options. Select "Standard" optimization and check "Document properties". Click OK, then Save.',
                'original_id' => 11
            ],
            ...
            12 => [
                'id' => 12,
                'question_number' => 12,
                'domain' => 'PERFORMANCE: Insert and Format Text',
                'text' => 'PERFORMANCE TASK: Apply the following formatting to the selected paragraph: Line spacing: 1.5 lines, Spacing Before: 12 pt, Spacing After: 6 pt.',
                'options' => [
                    'A' => 'Completed',
                    'B' => 'Not Completed',
                    'C' => 'Partially Completed',
                ...
                'points' => 20,
                'type' => 'performance',
                'instructions' => 'Select the paragraph. Go to Layout tab > Paragraph group. Set Line spacing to 1.5. Set Before to 12 pt. Set After to 6 pt.',
                'original_id' => 12
            ],
            ...
            13 => [
                'id' => 13,
                'question_number' => 13,
                'domain' => 'PERFORMANCE: Manage Tables',
                'text' => 'PERFORMANCE TASK: Convert the selected text to a table with 3 columns and auto-fit to contents.',
                'options' => [
                    'A' => 'Completed',
                    'B' => 'Not Completed',
                    'C' => 'Partially Completed',
                ...
                'points' => 25,
                'type' => 'performance',
                'instructions' => 'Select the text. Go to Insert tab > Table > Convert Text to Table. Set Number of columns to 3. Select "AutoFit to contents". Click OK.',
                'original_id' => 13
            ],
            ...
            14 => [
                'id' => 14,
                'question_number' => 14,
                'domain' => 'PERFORMANCE: References',
                'text' => 'PERFORMANCE TASK: Insert a footnote at the end of the first paragraph with the text: "Source: Microsoft Office 2019 documentation"',
                'options' => [
                    'A' => 'Completed',
                    'B' => 'Not Completed',
                    'C' => 'Partially Completed',
                ...
                'points' => 20,
                'type' => 'performance',
                'instructions' => 'Place cursor at end of first paragraph. Go to References tab > Insert Footnote. Type "Source: Microsoft Office 2019 documentation".',
                'original_id' => 14
            ],
            ...
            15 => [
                'id' => 15,
                'question_number' => 15,
                'domain' => 'PERFORMANCE: Graphics',
                'text' => 'PERFORMANCE TASK: Insert the picture "logo.jpg" and apply the "Drop Shadow Rectangle" picture style.',
                'options' => [
                    'A' => 'Completed',
                    'B' => 'Not Completed',
                    'C' => 'Partially Completed',
                ...
                'points' => 25,
                'type' => 'performance',
                'instructions' => 'Go to Insert tab > Pictures. Select "logo.jpg". With picture selected, go to Format tab > Picture Styles > Drop Shadow Rectangle.',
                'original_id' => 15
            ]
        ];
    }
...
{
    // Check if time_remaining exists in session
    if (!isset($_SESSION['mock_exam']['time_remaining'])) {
        return '45:00'; // Default starting time
    }
...
{
    // Check if exam is started and not completed
    $isStarted = isset($_SESSION['mock_exam']['started']) && $_SESSION['mock_exam']['started'] === true;
    $isCompleted = isset($_SESSION['mock_exam']['completed']) && $_SESSION['mock_exam']['completed'] === true;
...
{
    // Always update time remaining first
    ...
    private function displayStartScreen(): void
    {
        ...
        <head>
            ...
            <title>MO-100 Mock Exam - Impact Digital Academy</title>
            ...
            <style>
                * {
                ...
                .domain-item:nth-child(1) { border-color: #1976d2; background: #e3f2fd; }
                .domain-item:nth-child(2) { border-color: #388e3c; background: #e8f5e9; }
                .domain-item:nth-child(3) { border-color: #ff9800; background: #fff3e0; }
                .domain-item:nth-child(4) { border-color: #d32f2f; background: #ffebee; }
        ...
        <body>
            <div class="container">
                <div class="header">
                    <h1>MO-100 Mock Exam</h1>
                    <div class="subtitle">Microsoft Word (Office 2019) Certification Simulation</div>
                ...
                <div class="content">
                    <div class="exam-info-grid">
                        <div class="info-card">
                            ...
                            <h3>Exam Duration</h3>
                            <p>45 Minutes</p>
                            <p style="font-size: 0.8rem; color: #888; margin-top: 5px;">2700 seconds total</p>
                        </div>
                        ...
                        <div class="info-card">
                            ...
                            <p style="font-size: 0.8rem; color: #888; margin-top: 5px;"><?php echo ($this->total_exam_questions - 14); ?> Multiple Choice + 14 Performance</p>
                        </div>
                    ...
                    <div class="warning-box">
                        ...
                        <ul style="margin-left: 20px; margin-top: 10px;">
                            ...
                            <li>Always includes performance tasks (approximately 40%)</li>
                    ...
                    <div class="instructions">
                        ...
                        <ol>
                            <li><strong>Multiple Choice (<?php echo ($this->total_exam_questions - 14); ?> questions):</strong> Test your knowledge of Word features and functions</li>
                            <li><strong>Performance Tasks (14 questions):</strong> Simulate actual exam tasks - you'll need to complete actions in Word</li>
                        </ol>
                        
                        <h4 style="color: #333; margin: 20px 0 10px 0;">Download Required Files:</h4>
                        <div style="background: white; padding: 15px; border-radius: 5px; margin: 15px 0;">
                            <p><i class="fas fa-file-word"></i> <a href="#" style="color: #1976d2; text-decoration: none; font-weight: bold;">MO100_MockExam_Final.docx</a> - Main exam file</p>
                            <p><i class="fas fa-image"></i> <a href="#" style="color: #1976d2; text-decoration: none; font-weight: bold;">logo.jpg</a> - Image for graphic tasks</p>
                            <p style="margin-top: 10px; font-size: 0.9rem; color: #666;">Contains all content needed for performance tasks</p>
                        </div>
                    </div>
                    ...
                    <a href="<?php echo BASE_URL; ?>modules/shared/course_materials/MSWord/word_week8_view.php<?php echo $this->class_id ? '?class_id=' . $this->class_id : ''; ?>" class="back-link">
    ...
    private function getTempQuestionsForStartScreen(): array
    {
        ...
        $sql = "SELECT DISTINCT question_domain FROM mock_exam_questions 
                WHERE exam_type = 'MO-100' AND is_active = 1 LIMIT 5";
        ...
        if ($result && $result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                $temp_questions[$i] = [
                    'id' => $i,
                    'domain' => $row['question_domain'],
                    'type' => $i <= 14 ? 'performance' : 'multiple_choice',
    ...
    private function displayExamInterface(): void
    {
        ...
        // Safely get minutes for warning classes
    $minutes = 0;
    if (isset($_SESSION['mock_exam']['time_remaining'])) {
        ...
        <head>
            <meta charset="UTF-8">
            <meta name="viewport" content="width=device-width, initial-scale=1.0">
            <title>MO-100 Mock Exam In Progress - Impact Digital Academy</title>
            <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
            <style>
                * {
                    margin: 0;
        ...
        <body>
            <div class="exam-header">
                <div class="exam-title">MO-100 Mock Exam</div>
                    ...
                    <div class="question-container">
                        ...
                        <div class="performance-instructions">
                            ...
                            <p style="margin-top: 10px; font-weight: bold; color: #1976d2;">
                                ...
                                Use the file: <strong>MO100_MockExam_Final.docx</strong>
                            </p>
                        </div>
                        <?php endif; ?>
            ...
            <script>
                // Timer countdown
let timeRemaining = <?php echo isset($_SESSION['mock_exam']['time_remaining']) ? $_SESSION['mock_exam']['time_remaining'] : 2700; ?>;
let examSubmitted = <?php echo isset($_SESSION['mock_exam']['submitted']) && $_SESSION['mock_exam']['submitted'] ? 'true' : 'false'; ?>;
    ...
    private function displayResults(): void
    {
        ...
        <head>
            <meta charset="UTF-8">
            <meta name="viewport" content="width=device-width, initial-scale=1.0">
            <title>MO-100 Mock Exam Results - Impact Digital Academy</title>
            <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
            <style>
                * {
                    margin: 0;
                ...
                .header {
                    background: linear-gradient(135deg, <?php echo $passed ? '#4caf50' : '#1976d2'; ?> 0%, <?php echo $passed ? '#2e7d32' : '#0d47a1'; ?> 100%);
                    color: white;
                    padding: 40px;
                    text-align: center;
                    position: relative;
                ...
                .domain-1 .bar-fill { background: linear-gradient(90deg, #1976d2, #42a5f5); }
                .domain-2 .bar-fill { background: linear-gradient(90deg, #388e3c, #66bb6a); }
                .domain-3 .bar-fill { background: linear-gradient(90deg, #ff9800, #ffb74d); }
                .domain-4 .bar-fill { background: linear-gradient(90deg, #d32f2f, #ff5252); }
                .domain-5 .bar-fill { background: linear-gradient(90deg, #7b1fa2, #ab47bc); }

                .recommendations {
                    background: <?php echo $passed ? '#e8f5e9' : '#e3f2fd'; ?>;
                    border-left: 5px solid <?php echo $passed ? '#4caf50' : '#1976d2'; ?>;
                    padding: 25px;
                    margin: 30px 0;
                    border-radius: 0 10px 10px 0;
                }
                ...
                .recommendations h3 {
                    color: <?php echo $passed ? '#2e7d32' : '#0d47a1'; ?>;
                    margin-bottom: 15px;
                    display: flex;
                    align-items: center;
                    gap: 10px;
            ...
            <div class="container">
                <div class="header">
                    ...
                    <p style="margin-top: 20px; opacity: 0.9;">
                        <?php echo $passed 
                            ? 'You have demonstrated proficiency in Word skills!' 
                ...
                <div class="content">
                    ...
                    <div class="recommendations">
                        ...
                        <?php if ($passed): ?>
                        <ul>
                            <li>You're ready for the official MO-100 certification exam!</li>
                        ...
                        <ul>
                            ...
                            <li>Review Week 6 materials (Document Review & Collaboration) - this was your weakest area</li>
                            <li>Practice performance tasks with the provided Word files</li>
                    ...
                    <div class="action-buttons">
                        ...
                        <a href="<?php echo BASE_URL; ?>modules/shared/course_materials/MSWord/word_week8_view.php<?php echo $this->class_id ? '&class_id=' . $this->class_id : ''; ?>" 

...
<body>
    ...
    <script>
        ...
        const API = {
            submitAnswer: '../ajax/submit_answer.php',
            getQuizData: '../api/get_quiz_data.php',
            allStudents: '../api/get_quiz_data.php?action=all_students',
            quizState: '../api/get_quiz_data.php?action=state',
            readyStudents: '../api/get_quiz_data.php?action=ready_students'
        };
        ...
        function submitAnswer(option) {
            ...
            // Send to server - USING CORRECT PATH
